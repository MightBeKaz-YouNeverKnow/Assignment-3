# Assignment #3
 For prosess work please click on the file labeled "Prosess work.pdf"
 For Game Please use the .sln file
use ethier the A and D or left and right arrow keys to move 
...
collect coins to boost your score and collect the time orbs to add 30 seconds to your timer
 (THE COLLECTABLES, TIMER, SCOREKEEPING, AND MOVING PLATFORMS WERE ALL IDEAS THAT I TRANSLATED FROM WORK DURING DESIGN WEEK) 
